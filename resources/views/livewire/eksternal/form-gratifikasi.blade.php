  ...
  <div class="isolate bg-white pb-6 sm:py-32 lg:px-10">
    ...
    <form wire:submit.prevent="submit" class="mx-auto mt-3 max-w-xl sm:mt-20 bg-white shadow-xl rounded-lg p-6">
      ...
      <div class="mt-10">
        ...
        class="block w-full rounded-md bg-blue-bmti px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-[#60a5fa] transition ease-in-out duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-2xl font-normal text-gray-500 dark:text-gray-400">Laporan pengaduan Anda berhasil dikirim!</h3>
                <p class="mb-5 text-lg font-normal text-gray-500">Silakan cek email Anda untuk ID pengaduan yang dapat digunakan untuk memeriksa status pengaduan Anda. <span class="font-bold text-base text-gray-500">Terima kasih atas partisipasi Anda!</span></p>
