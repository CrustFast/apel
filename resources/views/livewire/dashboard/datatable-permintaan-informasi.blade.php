<div class="flex flex-col mt-8" id="hs-datatable-with-export" class="flex flex-col --prevent-on-load-init" data-hs-datatable='{
  "pageLength": 10,
  "pagingOptions": {
        ...
        <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700">
          <div>
            ...
            <p class="text-sm text-gray-600 dark:text-neutral-400 capitalize">
              laporan pengaduan permintaan informasi
            </p>
          </div>
