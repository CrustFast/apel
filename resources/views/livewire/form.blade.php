        ...
        <form wire:submit.prevent="submit" class="mx-auto mt-3 max-w-xl sm:mt-20 bg-white shadow-xl rounded-lg p-6">
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                <div class="sm:col-span-2">
                    <label for="klasifikasi-laporan"
                        class="block text-base font-bold leading-6 text-gray-900 text-center">Pilih Klasifikasi
                        Laporan</label>
                    <div class="mt-6 mb-8 space-y-6">
                        <div class="flex justify-center">
                            <div class="flex flex-col sm:flex-row items-start gap-x-3 gap-y-3">
                                <div class="flex items-center">
                                    <input id="pengaduan" name="push-notifications" type="radio" value="pengaduan"
                                        class="h-4 w-4 border-gray-300 text-blue-bmti focus:ring-blue-bmti"
                                        onclick="toggleElements()">
                                    <label for="pengaduan"
                                        class="block text-sm font-medium leading-6 text-gray-900 ml-2 text-left">Pengaduan</label>
                                </div>
                                <div class="flex items-center">
                                    <input id="permintaan-informasi" name="push-notifications" type="radio"
                                        value="permintaan-informasi"
                                        class="h-4 w-4 border-gray-300 text-blue-bmti focus:ring-blue-bmti"
                                        onclick="toggleElements()">
                                    <label for="permintaan-informasi"
                                        class="block text-sm font-medium leading-6 text-gray-900 ml-2 text-left">Permintaan
                                        Informasi</label>
                                </div>
                                <div class="flex items-center">
                                    <input id="saran" name="push-notifications" type="radio" value="saran"
                                        class="h-4 w-4 border-gray-300 text-blue-bmti focus:ring-blue-bmti"
                                        onclick="toggleElements()">
                                    <label for="saran"
                                        class="block text-sm font-medium leading-6 text-gray-900 ml-2 text-left">Saran</label>
                                </div>
                                <div class="flex items-center">
                                    <input id="kerusakan" name="push-notifications" type="radio" value="kerusakan"
                                        class="h-4 w-4 border-gray-300 text-blue-bmti focus:ring-blue-bmti"
                                        onclick="toggleElements()">
                                    <label for="kerusakan"
                                        class="block text-sm font-medium leading-6 text-gray-900 ml-2 text-left">Kerusakan</label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="tanggal-pengaduan-section" class="hidden">
                    <label for="tanggal-pengaduan" class="block text-sm font-semibold leading-6 text-gray-900">Tanggal
                        Pengaduan</label>
                    <div class="mt-2.5 relative max-w-sm">
                        ...
                        <input datepicker datepicker-buttons datepicker-autoselect-today type="text"
                            class="text-gray-900 text-sm rounded-lg shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Select date">
                    </div>
                </div>
                <div id="jenis-layanan-section" class="hidden">
                    <label for="jenis-layanan" class="block text-sm font-semibold leading-6 text-gray-900">Pilih Jenis
                        Layanan</label>
                    <div class="mt-2.5">
                        <select id="jenis-layanan" name="jenis-layanan" autocomplete="jenis-layanan"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-500 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-bmti sm:max-w-xs sm:text-sm sm:leading-6">
                ...
                <div id="tipe-section" class="hidden">
                    ...
                    <div class="mt-2.5">
                        <select id="tipe" name="tipe" autocomplete="tipe-name"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-500 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-bmti sm:max-w-xs sm:text-sm sm:leading-6">
                ...
                <div id="kategori-pengaduan-section" class="hidden">
                    <label for="kategori-pengaduan" class="block text-sm font-semibold leading-6 text-gray-900">Kategori
                        Pengaduan</label>
                    <div class="mt-2.5">
                ...
                <div class="sm:col-span-2">
                    <label for="identitas"
                        class="block text-sm font-semibold leading-6 text-gray-900 text-center mt-6 w-full">Identitas</label>
                    <div class="mt-3 space-y-6">
                        <div class="flex justify-start">
                            <div class="flex flex-col md:flex-row items-start gap-3">
                                <div class="flex items-center gap-x-2">
                                    <input id="identitas-lengkap" name="identitas-select" type="radio"
                                        class="h-4 w-4 border-gray-300 text-blue-bmti focus:ring-blue-bmti"
                                        onclick="toggleLengkapFields()">
                                    <label for="identitas-lengkap"
                                        class="block text-sm font-medium leading-6 text-gray-900">Lengkap</label>
                                </div>
                                <div class="flex items-center gap-x-2">
                                    <input id="peserta-diklat" name="identitas-select" type="radio"
                                        class="h-4 w-4 border-gray-300 text-blue-bmti focus:ring-blue-bmti"
                                        onclick="togglePesertaDiklatFields()">
                                    <label for="peserta-diklat"
                                        class="block text-sm font-medium leading-6 text-gray-900">Peserta
                                        Diklat</label>
                                </div>
                                <div class="flex items-center gap-x-2">
                                    <input id="peserta-pkl" name="identitas-select" type="radio"
                                        class="h-4 w-4 border-gray-300 text-blue-bmti focus:ring-blue-bmti"
                                        onclick="togglePesertaPklFields()">
                                    <label for="peserta-pkl"
                                        class="block text-sm font-medium leading-6 text-gray-900">Peserta PKL</label>
                                </div>
                                <div class="flex items-center gap-x-2">
                                    <input id="pengguna-fasilitas" name="identitas-select" type="radio"
                                        class="h-4 w-4 border-gray-300 text-blue-bmti focus:ring-blue-bmti"
                                        onclick="togglePenggunaFasilitasFields()">
                                    <label for="pengguna-fasilitas"
                                        class="block text-sm font-medium leading-6 text-gray-900">Pengguna
                                        Fasilitas</label>
                                </div>
                            </div>
                        </div>
                ...
                <div id="identitas-lengkap-fields" class="hidden">
                    <div class="sm:col-span-2 mt-6">
                        <label for="nama-lengkap" class="block text-sm font-semibold leading-6 text-gray-900">Nama
                            Lengkap</label>
                    ...
                    <div class="sm:col-span-2 mt-6">
                        <label for="nomor-telepon" class="block text-sm font-semibold leading-6 text-gray-900">Nomor
                            Telepon</label>
                        <div class="relative mt-3">
                            <input type="text" id="floating_outlined"
                                class="block px-2.5 pb-2.5 pt-2 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                ...
                <div id="peserta-diklat-fields" class="hidden">
                    <div class="sm:col-span-2 mt-6">
                        <label for="periode-diklat" class="block text-sm font-semibold leading-6 text-gray-900">Pilih
                            Periode Diklat</label>
                    ...
                    <div class="sm:col-span-2 mt-6">
                        <label for="nama-peserta-diklat"
                            class="block text-sm font-semibold leading-6 text-gray-900">Nama
                            Peserta</label>
                        <div class="relative mt-3">
                            <input type="text" id="floating_outlined"
                                class="block px-2.5 pb-2.5 pt-2 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    ...
                    <div class="sm:col-span-2 mt-6">
                        <label for="kategori-pengaduan"
                            class="block text-sm font-semibold leading-6 text-gray-900">Program Keahlian</label>
                        <div class="mt-2.5">
                            <select id="kategori-pengaduan" name="kategori-pengaduan" autocomplete="kategori-name"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-500 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-bmti sm:max-w-xs sm:text-sm sm:leading-6">
                ...
                <div id="peserta-pkl-fields" class="hidden">
                    <div class="sm:col-span-2 mt-6">
                        <label for="nama-peserta-pkl" class="block text-sm font-semibold leading-6 text-gray-900">Nama
                            Peserta PKL</label>
                        <div class="relative mt-3">
                            <input type="text" id="floating_outlined"
                                class="block px-2.5 pb-2.5 pt-2 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            ...
                            <label for="floating_outlined"
                                class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">Masukkan
                                Nama Peserta PKL</label>
                        </div>
                    </div>
                    <div class="sm:col-span-2 mt-6">
                        <label for="asal-smk" class="block text-sm font-semibold leading-6 text-gray-900">Asal
                            SMK</label>
                        <div class="relative mt-3">
                            <input type="text" id="floating_outlined"
                                class="block px-2.5 pb-2.5 pt-2 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                ...
                <div id="pengguna-fasilitas-fields" class="hidden">
                    <div class="sm:col-span-2 mt-6">
                        <label for="fasilitas-digunakan"
                            class="block text-sm font-semibold leading-6 text-gray-900">Fasilitas yang
                            Digunakan</label>
                        <div class="relative mt-3">
                            <input type="text" id="floating_outlined"
                                class="block px-2.5 pb-2.5 pt-2 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            ...
                            <label for="floating_outlined"
                                ...
                                Fasilitas yang Digunakan</label>
                        </div>
                    </div>
                    <div class="sm:col-span-2 mt-6">
                        <label for="tanggal-penggunaan"
                            class="block text-sm font-semibold leading-6 text-gray-900">Tanggal
                            Penggunaan</label>
                        <div class="relative mt-3 max-w-sm">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                                <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                ...
                <div class="sm:col-span-2 mt-6" id="isi-pengaduan-section">
                    <label for="isi-pengaduan" class="block text-sm font-semibold leading-6 text-gray-900">Isi
                        Pengaduan</label>
                    <div class="mt-2.5">
                        <textarea placeholder="Ketik Isi Laporan Anda" id="isi-pengaduan" rows="4"
                            class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-bmti sm:text-sm sm:leading-6"></textarea>
                    </div>
                </div>
                        ...
                        <div class="text-center">
                            ...
                            <div class="mt-4 flex text-sm leading-6 text-gray-600">
                                <label for="file-upload"
                                    class="relative cursor-pointer rounded-md bg-white font-semibold text-blue-bmti focus-within:outline-none focus-within:ring-2 focus-within:ring-blue-bmti focus-within:ring-offset-2 hover:text-[#9ca3af]">
            ...
            <div class="mt-10">
                <button type="submit"
                    class="block w-full rounded-md bg-blue-bmti px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-[#60a5fa] transition ease-in-out duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">ADUKAN!</button>
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    function toggleElements() {
        ...
        const sections = [uploadFotoSection, tanggalPengaduanSection, jenisLayananSection, tipeSection,
            kategoriPengaduanSection
        ];
