            ...
            <div class="flex justify-start">
              <div class="flex flex-col md:flex-row items-start gap-3">
                <div class="flex items-center gap-x-2">
                  <input id="identitas-lengkap" wire:model="selectedIdentity" name="identitas-select" type="radio" class="h-4 w-4 border-gray-300 text-blue-bmti focus:ring-blue-bmti">
                  <label for="identitas-lengkap" class="block text-sm font-medium leading-6 text-gray-900">Lengkap</label>
                </div>
                <div class="flex items-center gap-x-2">
                  <input id="peserta-diklat" wire:model="selectedIdentity" name="identitas-select" type="radio" class="h-4 w-4 border-gray-300 text-blue-bmti focus:ring-blue-bmti">
                  <label for="peserta-diklat" class="block text-sm font-medium leading-6 text-gray-900">Peserta Diklat</label>
                </div>
                <div class="flex items-center gap-x-2">
                  <input id="peserta-pkl" wire:model="selectedIdentity" name="identitas-select" type="radio" class="h-4 w-4 border-gray-300 text-blue-bmti focus:ring-blue-bmti">
                  <label for="peserta-pkl" class="block text-sm font-medium leading-6 text-gray-900">Peserta PKL</label>
                </div>
                <div class="flex items-center gap-x-2">
                  <input id="pengguna-fasilitas" wire:model="selectedIdentity" name="identitas-select" type="radio" class="h-4 w-4 border-gray-300 text-blue-bmti focus:ring-blue-bmti">
