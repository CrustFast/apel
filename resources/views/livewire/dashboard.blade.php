  ...
  <div class="w-full lg:ps-64">
    <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <div class="border-b border-gray-200 dark:border-neutral-700">
        <nav class="flex gap-x-1 uppercase" aria-label="Tabs" role="tablist" aria-orientation="horizontal">
      ...
      <div class="mt-3">
        <div id="tabs-with-icons-1" role="tabpanel" aria-labelledby="tabs-with-icons-item-1">
          @livewire('dashboard.datatable-aksi')
        </div>
        <div id="tabs-with-icons-2" class="hidden" role="tabpanel" aria-labelledby="tabs-with-icons-item-2">
          @livewire('dashboard.datatable-konfes')
        </div>
        <div id="tabs-with-icons-3" class="hidden" role="tabpanel" aria-labelledby="tabs-with-icons-item-3">
          @livewire('dashboard.datatable-sigap')
          @livewire('dashboard.datatable-permintaan-informasi')
          @livewire('dashboard.datatable-saran')
        </div>
