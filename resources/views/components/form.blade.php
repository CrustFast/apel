            ...
            <div class="flex justify-center">
              <div class="flex flex-col sm:flex-row items-start gap-x-3 gap-y-3">
                <div class="flex items-center">
                  <input id="pengaduan" name="push-notifications" type="radio" wire:model="selectedOption" value="pengaduan" onclick="text(0)" class="h-4 w-4 border-gray-300 text-blue-bmti focus:ring-blue-bmti">
                  <label for="pengaduan" class="block text-sm font-medium leading-6 text-gray-900 ml-2 text-left">Pengaduan</label>
                </div>
                <div class="flex items-center">
                  <input id="permintaan-informasi" name="push-notifications" type="radio" wire:model="selectedOption" class="h-4 w-4 border-gray-300 text-blue-bmti focus:ring-blue-bmti">
                ...
                <div class="flex items-center">
                  <input id="saran" name="push-notifications" type="radio" wire:model="selectedOption" class="h-4 w-4 border-gray-300 text-blue-bmti focus:ring-blue-bmti">
                  <label for="saran" class="block text-sm font-medium leading-6 text-gray-900 ml-2 text-left">Saran</label>
                </div>
                <div class="flex items-center">
                  <input id="kerusakan" name="push-notifications" type="radio" wire:model="selectedOption" onclick="text(1)" class="h-4 w-4 border-gray-300 text-blue-bmti focus:ring-blue-bmti">
