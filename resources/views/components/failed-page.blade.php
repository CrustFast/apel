  ...
  <main class="main-content" id="main-content">
    <div class="relative isolate overflow-hidden py-24 sm:py-32">
      <div class="flex flex-col items-center justify-center mx-auto max-w-7xl px-8 lg:px-8">
        <div class="flex flex-col items-center justify-center mx-auto max-w-2xl lg:mx-0">
          ...
          <h2 class="text-xl font-bold text-white sm:text-4xl tracking-wider mt-7 sm:mt-7 text-center">Laporan Gagal Terkirim!</h2>
          <p class="mt-1 text-lg leading-8 text-white text-center">Mohon maaf, terjadi kesalahan saat mengirim laporan Anda. Silakan periksa kembali data yang diinput dan coba lagi.</p>
          @if(session('errors'))
              <div class="bg-red-500 text-white p-4 rounded-md">
                  <h3 class="text-lg font-bold">Terdapat beberapa kesalahan:</h3>
          ...
          @endif
          <a href="{{ route('home.view') }}" class="mt-2 pr-6 inline-flex items-center rounded-3xl border border-white px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-white hover:text-[#cd472f] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900 transition-colors duration-300">
    ...
    <script>
        ...
        lottie.loadAnimation({
            ...
            path: '{{ asset('storage/failed_animation.json') }}' // Path animasi JSON
        });
