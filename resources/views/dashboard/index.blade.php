...
<body class="h-full">
    ...
    <aside id="logo-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <a href="https://flowbite.com/" class="flex items-center ps-2.5 mb-5 ml-1">
                <img src="{{ asset('img/logo-bmti.png') }}" class="h-8 me-3 sm:h-7" alt="APEL Logo" />
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">APEL</span>
            </a>
